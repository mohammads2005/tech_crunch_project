"""
Django settings for tech_crunch_proj project.
...
ROOT_URLCONF = 'tech_crunch_proj.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'techcrunch/template')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LOG_ROOT = os.path.join(BASE_DIR, "techcrunch.log")
